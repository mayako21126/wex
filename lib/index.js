      ...
      if (store) {
        ...
        if (Object.prototype.toString.call(this.tmp) === Object.prototype.toString.call(args)) {
          ...
          if (type == '[object Object]' || type == '[object Array]') {
            throttle = (0, _utils.isObjectValueEqual)(this.tmp, args);
          } else {
            throttle = this.tmp === args ? true : false;
          }
        }
        this.tmp = args;
        var targs = (0, _utils.deepCopy)(args);
        if (!throttle) {
...
function installModule(args, store) {
  ...
  var handler = function handler(a, b, c) {
    ...
    setTimeout(function () {
      ...
      _utils.Watch.call(store, oj, handler);
    }, 0);
  };
  _utils.Watch.call(store, store.$state, handler);
